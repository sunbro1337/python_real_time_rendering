...
class Render:
    ...
    def draw_world_2d(self, player_pos, player, world_map):
    ...
    def show_fps(self, clock):
        ...
        render_font = self.font.render(display_fps, False, ColorRGB.GREEN)
        self.sc.blit(render_font, (ScreenConfig.FPS_POSITION))

    def show_minimap(self, sc_mini_map, player, world_map):
